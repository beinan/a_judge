...
class StudentSubmissionView extends React.Component{
  constructor(props){
    super(props);
    this.state={};
  }
    ...
    return (
      <div>
        ...
        <section className="content-header">
          <h1>
            My submissions
            <small>All my submissions</small>
          </h1>
        ...
        <div className="content body">
          <div className="row">
            <CommonListBox url="/api/submissions" headers= {["Assignment", "Status", "Date", "Detail", "Total", "Late", "Final"]}
                           data_mapper={submission_mapper}
                           store_id="my_submission_list" page_size={10} />
            {modalInstance}
          </div>
